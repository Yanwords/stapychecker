...
from .builtin_types import WrapperDescriptorType, MethodWrapperType, MethodDescriptorType
...
def _type_repr(obj):
    ...
    if obj is ...:
        return('...')
    if isinstance(obj, builtin_types.FunctionType):
        return obj.__name__
    return repr(obj)
...
class _SpecialForm(_Final, _Immutable, _root=True):
    ...
    def __getitem__(self, parameters):
        ...
        if self._name == 'Union':
            ...
            # _GenericAlias can rename Union[int, str](<class int>, <class str>)) to Union[str,int]
...
_allowed_types = (builtin_types.FunctionType, builtin_types.BuiltinFunctionType,
                  builtin_types.MethodType, builtin_types.ModuleType,
...
def get_type_hints(obj, globalns=None, localns=None):
    ...
    if globalns is None:
        if isinstance(obj, builtin_types.ModuleType):
